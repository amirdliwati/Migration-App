...
class CreateInspectionQuotationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspection_quotations', function (Blueprint $table) {
            ...
            $table->unsignedInteger('currencies_id')->default('2')->index('quotations_in_currencies_id');
            $table->text('file_path')->nullable();
            $table->unsignedBigInteger('purchaseorder_id')->nullable()->index('po_quotations_IN');
            $table->unsignedBigInteger('template_id')->nullable()->index('template_quotations_IN');
